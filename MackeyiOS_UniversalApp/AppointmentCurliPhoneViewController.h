//
//  AppointmentCurliPhoneViewController.h
...
@interface AppointmentCurliPhoneViewController : UIViewController<UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,MFMailComposeViewControllerDelegate> {
