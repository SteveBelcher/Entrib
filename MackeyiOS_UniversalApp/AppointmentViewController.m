...
- (IBAction)actionForSubmit:(id)sender {
    ...
    if (txtName.text.length!=0 && txtDOB.text.length!=0 && txtEmail.text.length!=0 && txtPhone.text.length!=0 ) {
        ...
        //        if ([txtProvider.placeholder isEqualToString:@"SELECT ONE"]) {
        //            UIAlertView *alertview=[[UIAlertView alloc]initWithTitle:@"Error" message:@"Please select provider field" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        //            [alertview show];
        //
        //
        //
        ...
        //        }
        //
        //        else if([txtDate.placeholder isEqualToString:@"SELECT ONE"])
        //        {
        //            UIAlertView *alertview=[[UIAlertView alloc]initWithTitle:@"Error" message:@"Please select date field" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        //            [alertview show];
        //
        //        }
