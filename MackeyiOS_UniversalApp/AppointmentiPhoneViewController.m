//
//  AppointmentiPhoneViewController.m
...
#import "AppointmentiPhoneViewController.h"

@interface AppointmentiPhoneViewController ()

@end

@implementation AppointmentiPhoneViewController
...
- (void)viewDidLoad {
    ...
    if ([[UIScreen mainScreen] bounds].size.height == 568) {
        ...
        viewForPickers.frame=CGRectMake(0, 337, 320, 162);
        //scrollView.contentSize=CGSizeMake(320, 300);
        dateScrollSize=200;
        txtVisitScrollSize=200;
        
    } else {
        viewForPickers.frame=CGRectMake(0, 250, 320, 162);
        dateScrollSize=250;
